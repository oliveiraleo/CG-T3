...
const folhaTexture = loader.load('/CG-T3/T3/textures/folhas.jpg', function ( folhaTexture ) {
...
const pinheiroTexture = loader.load('/CG-T3/T3/textures/pinheiro.jpg', function ( pinheiroTexture ) {
...
const pinheiroTroncoTexture = loader.load('/CG-T3/T3/textures/tronco.jpg');
var pinheiroTroncoMaterial = new THREE.MeshLambertMaterial({
map: pinheiroTroncoTexture
});

var troncoTexture = loader.load('/CG-T3/T3/textures/tronco2.jpg');
